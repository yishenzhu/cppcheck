...
bool Platform::set(const std::string& platformstr, std::string& errstr, const std::vector<std::string>& paths, bool verbose)
{
    ...
    if (platformstr == "win32A") {
        ...
        std::cout << "Platform 'unix32-unsigned' is deprecated and will be removed in Cppcheck 2.14. Please use '--platform=unix32 --funsigned-char' instead." << std::endl;
        t = Type::Unix32;
        platformFile = platformstr;
    }
        ...
        std::cout << "Platform 'unix64-unsigned' is deprecated and will be removed in Cppcheck 2.14. Please use '--platform=unix64 --funsigned-char' instead." << std::endl;
        t = Type::Unix64;
        platformFile = platformstr;
    }
