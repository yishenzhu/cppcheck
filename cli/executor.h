...
class Executor {
public:
    Executor(const std::map<std::string, std::size_t> &files, const Settings &settings, Suppressions &suppressions, Suppressions &suppressionsNoFail, ErrorLogger &errorLogger);
    virtual ~Executor();
